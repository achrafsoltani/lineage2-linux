#!/bin/bash
# EURO-PVP.COM — launch script
# Starts the Interlude client under Wine. The server (x100 / x1200) is
# selected on the in-game server list; connection details are baked into
